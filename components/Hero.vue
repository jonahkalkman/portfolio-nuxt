<template>
  ...
  >
    <div
      class="w-full md:w-1/2 0 text-white py-6 px-4 md:py-10 md:px-8 flex items-start flex-col justify-center order-1"
    >
      ...
      <p class="text-lg md:text-xl mb-5">
        ...
        apps), Vue and TypeScript.
      </p>
      <Button
        title="Contact me"
        link="mailto:jonah@jkagency.nl"
